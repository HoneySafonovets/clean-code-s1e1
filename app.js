...
var createNewTaskElement=function(taskString){
    ...
    label.className = 'task-item__label tasks-item__task';

    //Each elements, needs appending
    checkBox.type = "checkbox";
    checkBox.className = 'task-item__input task-item__input-check';
    editInput.className ="task-item__input task-item__input-text tasks-item__task";
    editInput.type = "text";
    ...
    deleteButtonImg.className = 'tasks-remove';
